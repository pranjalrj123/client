...
public abstract class GameRules {
    ...
    boolean isSideEmpty(int pitNum) {
        // Implement this method in the abstract class if needed.
        // You can use gameBoard.isSideEmpty(pitNum) or provide custom logic.
    ...
    public void registerPlayers(Player one, Player two) {
        // Implement this method in the abstract class if needed.
        // You can use gameBoard.setStore(store, playerNum) to set the players' stores.
    }
